      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-4">
          <div className="flex flex-col gap-4 mb-4">
            <Toolbar currentTool={currentTool} onToolChange={setCurrentTool} onClear={clearCanvas} />
...
//       } else if (currentTool === "bucket") {
//         const imageData = ctx.getImageData(0, 0, canvas.width, canvas.height)
//         const newImageData = floodFill(imageData, pos.x, pos.y, currentColor)
//         ctx.putImageData(newImageData, 0, 0)
//       }
//     },
//     [currentTool, currentColor, brushSize, getMousePos],
...
//     <div className="min-h-screen bg-gray-100 p-4">
//       <div className="max-w-6xl mx-auto">
//         <h1 className="text-3xl font-bold text-center mb-6 text-gray-800">Paint Application</h1>
